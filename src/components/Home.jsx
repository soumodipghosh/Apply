...
const Home = () => {
  ...
  return (
    <div>
      ...
      <nav className='flex items-center justify-between bg-blac bg-blue-950 p-2 lg:p-2 gap-12 font-semibold fixed top-0 z-50 w-full'>
        ...
        <div className='flex gap-1 items-center'>
            ...
            <button className='bg-rose-400 p-1.5 md:px-3 rounded-lg text-white cursor-pointer' onClick={""}>Login</button>

        </div>
      </nav>

        <div className='flex-none lg:flex md:flex mt-20 px-10 py-5 md:px-10 lg:px-34 gap-0 md:gap-20 lg:gap-52 md:pl-8'>
          <div>
